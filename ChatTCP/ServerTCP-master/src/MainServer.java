...
public class MainServer extends javax.swing.JFrame {
    ...
    public void startRunning()
    {
        try
        {
            ...
            while(true)
            {
                try
                {
                    status.setText(" Aguardando alguem para se conectar...");
                    connection=server.accept();
                    status.setText(" Conectado agora com "+connection.getInetAddress().getHostName());
   ...
   private void whileChatting() throws IOException
   {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Escreva seu texto aqui");
        jPanel1.add(jLabel2);
